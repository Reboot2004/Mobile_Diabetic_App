...
class MultiSelectDropdown extends StatefulWidget {
  ...
  int numberOfItemsLabelToShow = 1;
  ...
  /// Checkbox fill color in list tile.
   Color? checkboxFillColor = Colors.blue;

  /// Splash color on the list tile when the list is clicked.
   Color? splashColor  = Colors.grey[350];
  ...
  /// Mutiple selection dropdown for List of Maps.
   MultiSelectDropdown({
    ...
    this.numberOfItemsLabelToShow = 1,
    this.boxDecoration,
    this.width,
    this.whenEmpty = '-Select-',
    this.isLarge = false,
  ...
  /// Mutiple selection dropdown for simple List.
   MultiSelectDropdown.simpleList({
    ...
    this.includeSelectAll = false,
    this.includeSearch = false,
    this.textStyle = const TextStyle(fontSize: 17, fontWeight: FontWeight.bold),
    this.duration = const Duration(milliseconds: 300),
    this.checkboxFillColor = Colors.white,
          ...
          child: MenuAnchor(
            ...
            style: MenuStyle(
              fixedSize: MaterialStateProperty.resolveWith((states) {
                return Size(modalWidth, modalHeight-30);
              }),
          ...
          children: [
            ...
            Checkbox(
              fillColor: MaterialStateProperty.resolveWith<Color>((states) {
                return Colors.black ?? themeData.primaryColor;
              }),
              value: value,
              onChanged: null,
            ),
